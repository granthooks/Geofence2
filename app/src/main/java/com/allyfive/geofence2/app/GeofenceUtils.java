...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.allyfive.geofence2.app.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.allyfive.geofence2.app.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.allyfive.geofence2.app.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.allyfive.geofence2.app.KEY_LATITUDE";
    public static final String KEY_LONGITUDE = "com.allyfive.geofence2.app.KEY_LONGITUDE";
    public static final String KEY_RADIUS = "com.allyfive.geofence2.app.KEY_RADIUS";
    public static final String KEY_EXPIRATION_DURATION =
            "com.allyfive.geofence2.app.KEY_EXPIRATION_DURATION";
    public static final String KEY_TRANSITION_TYPE =
            "com.allyfive.geofence2.app.KEY_TRANSITION_TYPE";
